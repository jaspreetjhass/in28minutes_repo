...
class EmployeeResourceWrapperWithMockServer2 {
	...
	public void findEmployeeById() throws Exception {
		...
		final RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/wrapper/employees/{empId}", new Object[] { "1" })
	...
	public void findAllEmployee() throws Exception {
		...
		final RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/wrapper/employees")
				.accept(org.springframework.http.MediaType.APPLICATION_JSON);
		final MvcResult mvcResult = mockMvc.perform(requestBuilder).andReturn();
		final String actualString = mvcResult.getResponse().getContentAsString();
	...
	public void addEmployee() throws Exception {
		...
		final String expectedString = jsonResourceParser.write(resource).getJson();
		...
		final RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/wrapper/employees")
	...
	public void updateEmployee() throws Exception {
		...
		final RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/wrapper/employees/1").content(expectedEmpString)
	...
	public void deleteEmployee() throws Exception {
		...
		final RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/wrapper/employees/1");
