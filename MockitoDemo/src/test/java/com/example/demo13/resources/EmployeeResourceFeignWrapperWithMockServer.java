package com.example.demo13.resources;
...
import com.example.demo13.SpringBootTestApp;
...
class EmployeeResourceFeignWrapperWithMockServer {
	...
	public void afterTest() {
		HttpRequest[] expectations = clientAndServer.retrieveRecordedRequests(request());
		Stream.of(expectations).forEach(System.out::println);
